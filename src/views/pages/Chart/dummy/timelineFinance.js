...
export const dataFormatter = (obj) => {
  let pList = ['Beijing','Tianjin','Hebei','Shanxi','Inner Mongolia','Liaoning','Jilin','Heilongjiang','Shanghai','Jiangsu','Zhejiang','Anhui','Fujian ','Jiangxi','Shandong','Henan','Hubei','Hunan','Guangdong','Guangxi','Hainan','Chongqing','Sichuan','Guizhou','Yunnan', 'Tibet','Shaanxi','Gansu','Qinghai','Ningxia','Xinjiang'];
  let temp;
...
const option = {
  baseOption: {
    timeline: {
      ...
      data: [
        '2002-01-01','2003-01-01','2004-01-01',
        {
          value: '2005-01-01',
          tooltip: {
              formatter: '{b} GDP Reach a height'
          },
          symbol: 'diamond',
          symbolSize: 16
        },
        '2006-01-01', '2007-01-01','2008-01-01','2009-01-01','2010-01-01',
        {
          ...
          tooltip: {
            formatter: function (params) {
              return params.name + 'GDP Reach another height';
            }
          },
          symbol: 'diamond',
          symbolSize: 18
    ...
    title: {
      subtext: 'Data comes from the National Bureau of Statistics'
    },
    tooltip: {
    },
    legend: {
    ...
    xAxis: [
      {
        'type':'category',
        'axisLabel':{'interval':0,rotate:43},
        'data':[
  ...
  options: [
    {
      ...
      series: [
        ...
        {data: [
          {name:'Real Estate', value: dataMap.dataEstate['2002sum']},
    ...
    },
    {
      ...
      series: [
        ...
        {data: [
          {name:'Real Estate', value: dataMap.dataEstate['2003sum']},
    ...
    },
    {
      ...
      series: [
        ...
        {data: [
          {name:'Real Estate', value: dataMap.dataEstate['2004sum']},
    ...
    },
    {
      ...
      series: [
        ...
        {data: [
          {name:'Real Estate', value: dataMap.dataEstate['2005sum']},
    ...
    },
    {
      ...
      series: [
        ...
        {data: [
          {name:'Real Estate', value: dataMap.dataEstate['2006sum']},
    ...
    },
    {
      ...
      series: [
        ...
        {data: [
          {name:'Real Estate', value: dataMap.dataEstate['2007sum']},
    ...
    },
    {
      ...
      series: [
        ...
        {data: [
          {name:'Real Estate', value: dataMap.dataEstate['2008sum']},
    ...
    },
    {
      ...
      series: [
        ...
        {data: [
          {name:'Real Estate', value: dataMap.dataEstate['2009sum']},
    ...
    },
    {
      ...
      series: [
        ...
        {data: [
          {name:'Real Estate', value: dataMap.dataEstate['2010sum']},
    ...
    },
    {
      ...
      series: [
        ...
        {data: [
          {name:'Real Estate', value: dataMap.dataEstate['2011sum']},
